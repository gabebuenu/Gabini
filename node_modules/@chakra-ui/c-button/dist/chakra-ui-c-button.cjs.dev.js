...
var CButtonGroup = vue.defineComponent({
  name: "CButtonGroup",
  props: props,
...
var CButtonSpinner = vue.defineComponent({
  ...
  setup: function setup(props, _ref) {
    var attrs = _ref.attrs;
    var marginProp = vue.computed(function () {
      return props.placement === "start" ? "marginEnd" : "marginStart";
    });
    var spinnerStyles = vue.computed(function () {
      var _ref2;
    ...
    return function () {
      return (// @ts-ignore
        vue.createVNode(vueSystem.chakra.div, vue.mergeProps({
          "__label": "button__spinner"
        }, spinnerStyles.value, attrs), {
          "default": function _default() {
            return [vue.createVNode(cSpinner.CSpinner, {
              "width": "1em",
              "height": "1em"
            }, null)];
          }
...
var CButtonContent = vue.defineComponent({
  name: "CButtonContent",
  props: {
    leftIcon: String,
    rightIcon: String,
  ...
  setup: function setup(props, _ref3) {
    ...
    return function () {
      return vue.createVNode(vue.Fragment, null, [props.leftIcon && vue.createVNode(CButtonIcon, {
        "icon": props.leftIcon,
        "marginEnd": props.iconSpacing
      }, null), slots == null ? void 0 : slots["default"] == null ? void 0 : slots["default"](), props.rightIcon && vue.createVNode(CButtonIcon, {
...
var CButton = vue.defineComponent({
  ...
  setup: function setup(_props, _ref5) {
    ...
    var props = vue.computed(function () {
      return utils.mergeWith({}, defaultButtonProps, _props, attrs);
    });
    ...
    var styles = vueSystem.useStyleConfig("Button", vue.computed(function () {
      return _extends({}, group == null ? void 0 : group.value, themingProps.value);
    }));

    var _focus = vue.computed(function () {
      var _styles$value$_focus, _styles$value;

      return utils.mergeWith({}, (_styles$value$_focus = (_styles$value = styles.value) == null ? void 0 : _styles$value["_focus"]) != null ? _styles$value$_focus : {}, {
        zIndex: 1
      });
    });
    ...
    return function () {
      return vue.createVNode(vueSystem.chakra.button, vue.mergeProps({
        "as": props.value.as,
        "label": "button"
        ...
        "data-active": utils.dataAttr(props.value.isActive),
        "data-loading": utils.dataAttr(props.value.isLoading),
        "__css": buttonStyles.value
      }, attrs), {
        "default": function _default() {
          return vue.createVNode(vue.Fragment, null, [props.value.isLoading && props.value.spinnerPlacement === "start" && vue.createVNode(CButtonSpinner, {
            "placement": "start",
          ...
          }, null), props.value.isLoading ? props.value.loadingText || vue.createVNode(vueSystem.chakra.span, {
            "opacity": 0
          }, {
            "default": function _default() {
              return [vue.createVNode(CButtonContent, {
          ...
          }) : vue.createVNode(CButtonContent, {
            "leftIcon": props.value.leftIcon,
            "rightIcon": props.value.rightIcon,
            "iconSpacing": props.value.iconSpacing
          }, {
          ...
          }), props.value.isLoading && props.value.spinnerPlacement === "end" && vue.createVNode(CButtonSpinner, {
            "placement": "end",
            "spacing": props.value.iconSpacing,
...
var CIconButton = vue.defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      return vue.createVNode(CButton, vue.mergeProps({
        "padding": "0",
        "rounded": props.isRound ? "rounded" : "md",
        "aria-label": props.ariaLabel
      }, attrs), {
        "default": function _default() {
          return [vue.createVNode(cIcon.CIcon, {
            "aria-hidden": true,
            "focusable": 0,
            "name": props.icon
          }, null)];
...
exports.CIconButton = CIconButton;
