 ...
 */
var CBreadcrumb = vue.defineComponent(function (props, _ref) {
  ...
  var styles = vueSystem.useMultiStyleConfig("Breadcrumb", themingProps);
  vueSystem.StylesProvider(styles);
  var separator = vue.computed(function () {
    if (slots.separator) {
      return slots == null ? void 0 : slots.separator == null ? void 0 : slots.separator();
    } else {
      return typeof props.separator === "string" ? props.separator : vueUtils.isObjectComponent(props.separator) ? // TODO:
      // Add support for
  ...
  return function () {
    ...
    return vue.createVNode(vueSystem.chakra.nav, vue.mergeProps({
      "as": props.as,
      "__label": "breadcrumb",
      ...
      "default": function _default() {
        return [vue.createVNode(vueSystem.chakra.ol, {
 ...
 * each breacrumb item.
 */
var CBreadcrumbSeparator = vue.defineComponent({
  props: {
  ...
  setup: function setup(props, _ref2) {
    ...
    var separatorStyles = vue.computed(function () {
      return _extends({
        display: "flex",
        mx: props.spacing
    ...
    return function () {
      return vue.createVNode(vueSystem.chakra.span, vue.mergeProps({
        "role": "presentation",
...
var CBreadcrumbItem = vue.defineComponent(function (props, _ref3) {
  _ref3.attrs;
  ...
  return function () {
    ...
    return vue.createVNode(vueSystem.chakra.li, {
      "__label": "breadcrumb__list-item",
      "__css": itemStyles.value
    }, {
      "default": function _default() {
        return [children, !props.isLastChild && vue.createVNode(CBreadcrumbSeparator, {
          "spacing": props.spacing
        }, {
          "default": function _default() {
            return props.separator;
 ...
 */
var CBreadcrumbLink = vue.defineComponent(function (props, _ref4) {
  ...
  return function () {
    ...
    return vue.createVNode(vueSystem.chakra.a, vue.mergeProps({
      "__label": "breadcrumb__link",
      "as": props.as,
      "__css": styles.value.link
    }, attrs), _isSlot(slots) ? slots : {
