...
var vueAnatomy = require('@chakra-ui/vue-anatomy');
var vueThemeTools = require('@chakra-ui/vue-theme-tools');
...
var Accordion = {
  parts: vueAnatomy.accordionAnatomy.keys,
...
function getBg(props) {
  var theme = props.theme,
      c = props.colorScheme;
  var lightBg = vueThemeTools.getColor(theme, c + ".100", c);
  var darkBg = vueThemeTools.transparentize(c + ".200", 0.16)(theme);
  return vueThemeTools.mode(lightBg, darkBg)(props);
}
...
var variantSubtle$1 = function variantSubtle(props) {
  ...
  return {
    ...
    icon: {
      color: vueThemeTools.mode(c + ".500", c + ".200")(props)
    },
    spinner: {
      color: vueThemeTools.mode(c + ".500", c + ".200")(props)
    }
...
var variantLeftAccent = function variantLeftAccent(props) {
  ...
  return {
    container: {
      ...
      borderStartColor: vueThemeTools.mode(c + ".500", c + ".200")(props),
      bg: getBg(props)
    },
    icon: {
      color: vueThemeTools.mode(c + ".500", c + ".200")(props)
...
var variantTopAccent = function variantTopAccent(props) {
  ...
  return {
    container: {
      pt: 2,
      borderTopWidth: "4px",
      borderTopColor: vueThemeTools.mode(c + ".500", c + ".200")(props),
      bg: getBg(props)
    },
    icon: {
      color: vueThemeTools.mode(c + ".500", c + ".200")(props)
...
var variantSolid$3 = function variantSolid(props) {
  ...
  return {
    container: {
      bg: vueThemeTools.mode(c + ".500", c + ".200")(props),
      color: vueThemeTools.mode("white", "gray.900")(props)
    }
  };
};
...
var Alert = {
  parts: vueAnatomy.alertAnatomy.keys,
...
var baseStyleBadge = function baseStyleBadge(props) {
  return {
    borderRadius: "full",
    border: "0.2em solid",
    borderColor: vueThemeTools.mode("white", "gray.800")(props),
    display: "flex",
    alignItems: "center",
...
var baseStyleExcessLabel = function baseStyleExcessLabel(props) {
  return {
    bg: vueThemeTools.mode("gray.200", "whiteAlpha.400")(props)
  };
};
...
var baseStyleContainer$3 = function baseStyleContainer(props) {
  var name = props.name,
      theme = props.theme;
  var bg = name ? vueThemeTools.randomColor({
    string: name
  }) : "gray.400";
  var isBgDark = vueThemeTools.isDark(bg)(theme);
  var color = "white";
  if (!isBgDark) color = "gray.800";
  var outlineColor = vueThemeTools.mode("white", "gray.800")(props);
  return {
    bg: bg,
    color: color,
    outline: "2px solid",
...
var Avatar = {
  parts: vueAnatomy.avatarAnatomy.keys,
...
var variantSolid$2 = function variantSolid(props) {
  var c = props.colorScheme,
      theme = props.theme;
  var dark = vueThemeTools.transparentize(c + ".500", 0.6)(theme);
  return {
    bg: vueThemeTools.mode(c + ".500", dark)(props),
    color: vueThemeTools.mode("white", "whiteAlpha.800")(props)
  };
};
...
var variantSubtle = function variantSubtle(props) {
  ...
  var darkBg = vueThemeTools.transparentize(c + ".200", 0.16)(theme);
  return {
    bg: vueThemeTools.mode(c + ".100", darkBg)(props),
    color: vueThemeTools.mode(c + ".800", c + ".200")(props)
  };
};
...
var variantOutline$2 = function variantOutline(props) {
  var c = props.colorScheme,
      theme = props.theme;
  var darkColor = vueThemeTools.transparentize(c + ".200", 0.8)(theme);
  var lightColor = vueThemeTools.getColor(theme, c + ".500");
  var color = vueThemeTools.mode(lightColor, darkColor)(props);
  return {
    color: color,
...
var Breadcrumb = {
  parts: vueAnatomy.breadcrumbAnatomy.keys,
...
var variantGhost = function variantGhost(props) {
  ...
  if (c === "gray") {
    return {
      color: vueThemeTools.mode("inherit", "whiteAlpha.900")(props),
      _hover: {
        bg: vueThemeTools.mode("gray.100", "whiteAlpha.200")(props)
      },
      _active: {
        bg: vueThemeTools.mode("gray.200", "whiteAlpha.300")(props)
      }
    };
  }

  var darkHoverBg = vueThemeTools.transparentize(c + ".200", 0.12)(theme);
  var darkActiveBg = vueThemeTools.transparentize(c + ".200", 0.24)(theme);
  return {
    color: vueThemeTools.mode(c + ".600", c + ".200")(props),
    bg: "transparent",
    _hover: {
      bg: vueThemeTools.mode(c + ".50", darkHoverBg)(props)
    },
    _active: {
      bg: vueThemeTools.mode(c + ".100", darkActiveBg)(props)
    }
  };
};
...
var variantOutline$1 = function variantOutline(props) {
  var c = props.colorScheme;
  var borderColor = vueThemeTools.mode("gray.200", "whiteAlpha.300")(props);
  return _extends({
    border: "1px solid",
...
var variantSolid$1 = function variantSolid(props) {
  ...
  if (c === "gray") {
    var _bg = vueThemeTools.mode("gray.100", "whiteAlpha.200")(props);
    ...
    return {
      ...
      _active: {
        bg: vueThemeTools.mode("gray.300", "whiteAlpha.400")(props)
      }
    };
  }
  ...
  var background = vueThemeTools.mode(bg, c + ".200")(props);
  return {
    bg: background,
    color: vueThemeTools.mode(color, "gray.800")(props),
    _hover: {
      bg: vueThemeTools.mode(hoverBg, c + ".300")(props),
      _disabled: {
        bg: background
      }
    },
    _active: {
      bg: vueThemeTools.mode(activeBg, c + ".400")(props)
    }
  };
};
...
var variantLink = function variantLink(props) {
  ...
  return {
    ...
    _active: {
      color: vueThemeTools.mode(c + ".700", c + ".500")(props)
    }
  };
};
...
var baseStyleControl$1 = function baseStyleControl(props) {
  ...
  return {
    ...
    _checked: {
      bg: vueThemeTools.mode(c + ".500", c + ".200")(props),
      borderColor: vueThemeTools.mode(c + ".500", c + ".200")(props),
      color: vueThemeTools.mode("white", "gray.900")(props),
      _hover: {
        bg: vueThemeTools.mode(c + ".600", c + ".300")(props),
        borderColor: vueThemeTools.mode(c + ".600", c + ".300")(props)
      },
      _disabled: {
        borderColor: vueThemeTools.mode("gray.200", "transparent")(props),
        bg: vueThemeTools.mode("gray.200", "whiteAlpha.300")(props),
        color: vueThemeTools.mode("gray.500", "whiteAlpha.500")(props)
      }
    },
    _indeterminate: {
      bg: vueThemeTools.mode(c + ".500", c + ".200")(props),
    ...
    _disabled: {
      bg: vueThemeTools.mode("gray.100", "whiteAlpha.100")(props),
      borderColor: vueThemeTools.mode("gray.100", "transparent")(props)
    },
    _focusVisible: {
      boxShadow: "outline"
    },
    _invalid: {
      borderColor: vueThemeTools.mode("red.500", "red.300")(props)
    }
  };
};
...
var Checkbox = {
  parts: vueAnatomy.checkboxAnatomy.keys,
...
var $size$1 = vueThemeTools.cssVar("close-button-size");

var baseStyle$w = function baseStyle(props) {
  var hoverBg = vueThemeTools.mode("blackAlpha.100", "whiteAlpha.100")(props);
  var activeBg = vueThemeTools.mode("blackAlpha.200", "whiteAlpha.200")(props);
  return {
    w: [$size$1.reference],
    h: [$size$1.reference],
    borderRadius: "md",
...
var baseStyleDialog$1 = function baseStyleDialog(props) {
  ...
  return _extends({}, isFullHeight && {
    ...
    zIndex: "modal",
    maxH: "100vh",
    bg: vueThemeTools.mode("white", "gray.700")(props),
    color: "inherit",
    boxShadow: vueThemeTools.mode("lg", "dark-lg")(props)
  });
};
...
var Drawer = {
  parts: vueAnatomy.drawerAnatomy.keys,
...
var Editable = {
  parts: vueAnatomy.editableAnatomy.keys,
...
var baseStyleRequiredIndicator = function baseStyleRequiredIndicator(props) {
  return {
    marginStart: 1,
    color: vueThemeTools.mode("red.500", "red.300")(props)
  };
};
...
var baseStyleHelperText = function baseStyleHelperText(props) {
  return {
    mt: 2,
    color: vueThemeTools.mode("gray.500", "whiteAlpha.600")(props),
    lineHeight: "normal",
    fontSize: "sm"
  };
};
...
var Form = {
  parts: vueAnatomy.formAnatomy.keys,
...
var FormError = {
  parts: vueAnatomy.formErrorAnatomy.keys,
...
function getDefaults(props) {
  ...
  return {
    focusBorderColor: fc || vueThemeTools.mode("blue.500", "blue.300")(props),
    errorBorderColor: ec || vueThemeTools.mode("red.500", "red.300")(props)
  };
}
...
var variantOutline = function variantOutline(props) {
  ...
  return {
    field: {
      ...
      bg: "inherit",
      _hover: {
        borderColor: vueThemeTools.mode("gray.300", "whiteAlpha.400")(props)
      },
      _readOnly: {
      ...
      _invalid: {
        borderColor: vueThemeTools.getColor(theme, ec),
        boxShadow: "0 0 0 1px " + vueThemeTools.getColor(theme, ec)
      },
      _focusVisible: {
        zIndex: 1,
        borderColor: vueThemeTools.getColor(theme, fc),
        boxShadow: "0 0 0 1px " + vueThemeTools.getColor(theme, fc)
      }
    },
    addon: {
      border: "1px solid",
      borderColor: vueThemeTools.mode("inherit", "whiteAlpha.50")(props),
      bg: vueThemeTools.mode("gray.100", "whiteAlpha.300")(props)
    }
  };
};
...
var variantFilled = function variantFilled(props) {
  ...
  return {
    field: {
      ...
      bg: vueThemeTools.mode("gray.100", "whiteAlpha.50")(props),
      _hover: {
        bg: vueThemeTools.mode("gray.200", "whiteAlpha.100")(props)
      },
      _readOnly: {
        boxShadow: "none !important",
        userSelect: "all"
...
var variantFlushed = function variantFlushed(props) {
  ...
  return {
    field: {
      ...
      _invalid: {
        borderColor: vueThemeTools.getColor(theme, ec),
        boxShadow: "0px 1px 0px 0px " + vueThemeTools.getColor(theme, ec)
      },
      _focusVisible: {
        borderColor: vueThemeTools.getColor(theme, fc),
        boxShadow: "0px 1px 0px 0px " + vueThemeTools.getColor(theme, fc)
      }
    },
    addon: {
...
var Input = {
  parts: vueAnatomy.inputAnatomy.keys,
...
var baseStyle$l = function baseStyle(props) {
  return {
    bg: vueThemeTools.mode("gray.100", "whiteAlpha")(props),
    borderRadius: "md",
    borderWidth: "1px",
...
var List = {
  parts: vueAnatomy.listAnatomy.keys,
  baseStyle: baseStyle$j
};

var baseStyleList = function baseStyleList(props) {
  return {
    bg: vueThemeTools.mode("#fff", "gray.700")(props),
    boxShadow: vueThemeTools.mode("sm", "dark-lg")(props),
    color: "inherit",
    minW: "3xs",
    py: "2",
    zIndex: 1,
...
var baseStyleItem = function baseStyleItem(props) {
  return {
    ...
    _active: {
      bg: vueThemeTools.mode("gray.200", "whiteAlpha.200")(props)
    },
    _expanded: {
      bg: vueThemeTools.mode("gray.100", "whiteAlpha.100")(props)
    },
...
var Menu = {
  parts: vueAnatomy.menuAnatomy.keys,
...
var Modal = {
  parts: vueAnatomy.modalAnatomy.keys,
...
var $stepperWidth = vueThemeTools.cssVar("number-input-stepper-width");
var $inputPadding = vueThemeTools.cssVar("number-input-input-padding");
var inputPaddingValue = vueThemeTools.calc($stepperWidth).add("0.5rem").toString();
...
var baseStyleStepper = function baseStyleStepper(props) {
  return {
    ...
    borderStartColor: vueThemeTools.mode("inherit", "whiteAlpha.300")(props),
    color: vueThemeTools.mode("inherit", "whiteAlpha.800")(props),
    _active: {
      bg: vueThemeTools.mode("gray.200", "whiteAlpha.300")(props)
    },
    _disabled: {
...
function getSize(size) {
  ...
  return {
    ...
    stepper: {
      fontSize: vueThemeTools.calc(fontSize).multiply(0.75).toString(),
      _first: {
...
var NumberInput = {
  parts: vueAnatomy.numberInputAnatomy.keys,
...
var $popperBg = vueThemeTools.cssVar("popper-bg");
var $arrowBg$1 = vueThemeTools.cssVar("popper-arrow-bg");
var $arrowShadowColor = vueThemeTools.cssVar("popper-arrow-shadow-color");
var baseStylePopper = {
  zIndex: 10
};
...
var baseStyleContent = function baseStyleContent(props) {
  ...
  var bg = vueThemeTools.mode("white", "gray.700")(props);
  var shadowColor = vueThemeTools.mode("gray.200", "whiteAlpha.300")(props);
...
var Popover = {
  parts: vueAnatomy.popoverAnatomy.keys,
...
function filledStyle(props) {
  ...
  var stripeStyle = vueThemeTools.mode(vueThemeTools.generateStripe(), vueThemeTools.generateStripe("1rem", "rgba(0,0,0,0.1)"))(props);
  var bgColor = vueThemeTools.mode(c + ".500", c + ".200")(props);
  var gradient = "linear-gradient(\n    to right,\n    transparent 0%,\n    " + vueThemeTools.getColor(t, bgColor) + " 50%,\n    transparent 100%\n  )";
...
var Progress = {
  parts: vueAnatomy.progressAnatomy.keys,
  sizes: sizes$a,
  baseStyle: baseStyle$d,
...
var Radio = {
  parts: vueAnatomy.radioAnatomy.keys,
  baseStyle: baseStyle$c,
  sizes: sizes$9,
...
var Select = {
  parts: vueAnatomy.selectAnatomy.keys,
  baseStyle: baseStyle$b,
  sizes: sizes$8,
...
var baseStyle$a = function baseStyle(props) {
  var defaultStartColor = vueThemeTools.mode("gray.100", "gray.800")(props);
  var defaultEndColor = vueThemeTools.mode("gray.400", "gray.600")(props);
  var _props$startColor = props.startColor,
      ...
      speed = props.speed,
      theme = props.theme;
  var start = vueThemeTools.getColor(theme, startColor);
  var end = vueThemeTools.getColor(theme, endColor);
  return {
    opacity: 0.7,
    borderRadius: "2px",
    borderColor: start,
...
var baseStyleTrack$1 = function baseStyleTrack(props) {
  return {
    ...
    bg: vueThemeTools.mode("gray.200", "whiteAlpha.200")(props),
    _disabled: {
      bg: vueThemeTools.mode("gray.300", "whiteAlpha.300")(props)
    }
  };
};
...
var Slider = {
  parts: vueAnatomy.sliderAnatomy.keys,
  sizes: sizes$7,
...
var $size = vueThemeTools.cssVar("spinner-size");
var baseStyle$7 = {
...
var Stat = {
  parts: vueAnatomy.statAnatomy.keys,
...
var $width = vueThemeTools.cssVar("switch-track-width");
var $height = vueThemeTools.cssVar("switch-track-height");
var $diff = vueThemeTools.cssVar("switch-track-diff");
var diffValue = vueThemeTools.calc.subtract($width, $height);
var $translateX = vueThemeTools.cssVar("switch-thumb-x");
...
var baseStyle$5 = function baseStyle(props) {
  ...
  return {
    container: (_container = {}, _container[$diff.variable] = diffValue, _container[$translateX.variable] = $diff.reference, _container._rtl = (_rtl = {}, _rtl[$translateX.variable] = vueThemeTools.calc($diff).negate().toString(), _rtl), _container),
...
var Switch = {
  parts: vueAnatomy.switchAnatomy.keys,
...
var variantSimple = function variantSimple(props) {
  ...
  return {
    th: _extends({
      color: vueThemeTools.mode("gray.600", "gray.400")(props),
      borderBottom: "1px",
      borderColor: vueThemeTools.mode(c + ".100", c + ".700")(props)
    }, numericStyles),
    td: _extends({
      borderBottom: "1px",
      borderColor: vueThemeTools.mode(c + ".100", c + ".700")(props)
    ...
    caption: {
      color: vueThemeTools.mode("gray.600", "gray.100")(props)
    },
    tfoot: {
      tr: {
        "&:last-of-type": {
    ...
    tbody: {
      tr: {
        "&:nth-of-type(odd)": {
          ...
          td: {
            background: vueThemeTools.mode(c + ".100", c + ".700")(props)
          }
        }
      }
    },
...
var Table = {
  parts: vueAnatomy.tableAnatomy.keys,
...
var variantLine = function variantLine(props) {
  ...
  return {
    ...
    tab: (_tab = {}, _tab[borderProp] = "2px solid", _tab.borderColor = "transparent", _tab[marginProp] = "-2px", _tab._selected = {
      color: vueThemeTools.mode(c + ".600", c + ".300")(props),
  ...
  return {
    tab: {
      ...
      _selected: {
        color: vueThemeTools.mode(c + ".600", c + ".300")(props),
        borderColor: "inherit",
        borderBottomColor: vueThemeTools.mode("white", "gray.800")(props)
      }
    },
    tablist: {
      mb: "-1px",
...
var variantEnclosedColored = function variantEnclosedColored(props) {
  ...
  return {
    tab: {
      border: "1px solid",
      borderColor: "inherit",
      bg: vueThemeTools.mode("gray.50", "whiteAlpha.50")(props),
      mb: "-1px",
      _notLast: {
        marginEnd: "-1px"
      },
      _selected: {
        bg: vueThemeTools.mode("#fff", "gray.800")(props),
        color: vueThemeTools.mode(c + ".600", c + ".300")(props),
        borderColor: "inherit",
...
var variantSoftRounded = function variantSoftRounded(props) {
  ...
  return {
    tab: {
      ...
      color: "gray.600",
      _selected: {
        color: vueThemeTools.getColor(theme, c + ".700"),
        bg: vueThemeTools.getColor(theme, c + ".100")
      }
    }
  };
};
...
var variantSolidRounded = function variantSolidRounded(props) {
  ...
  return {
    tab: {
      borderRadius: "full",
      fontWeight: "semibold",
      color: vueThemeTools.mode("gray.600", "inherit")(props),
      _selected: {
        color: vueThemeTools.mode("#fff", "gray.800")(props),
        bg: vueThemeTools.mode(c + ".600", c + ".300")(props)
      }
    }
  };
...
var Tabs = {
  parts: vueAnatomy.tabsAnatomy.keys,
...
var Tag = {
  parts: vueAnatomy.tagAnatomy.keys,
  variants: variants$1,
...
var $bg = vueThemeTools.cssVar("tooltip-bg");
var $arrowBg = vueThemeTools.cssVar("popper-arrow-bg");

var baseStyle = function baseStyle(props) {
  var _ref;

  var bg = vueThemeTools.mode("gray.700", "gray.300")(props);
  return _ref = {}, _ref[$bg.variable] = "colors." + bg, _ref.px = "8px", _ref.py = "2px", _ref.bg = [$bg.reference], _ref[$arrowBg.variable] = [$bg.reference], _ref.color = vueThemeTools.mode("whiteAlpha.900", "gray.900")(props), _ref.borderRadius = "sm", _ref.fontWeight = "medium", _ref.fontSize = "sm", _ref.boxShadow = "md", _ref.maxW = "320px", _ref.zIndex = "tooltip", _ref;
};
...
var breakpoints = vueThemeTools.createBreakpoints({
  sm: "30em",
  md: "48em",
  lg: "62em",
  xl: "80em",
...
var styles = {
  global: function global(props) {
    return {
      body: {
        fontFamily: "body",
        color: vueThemeTools.mode("gray.800", "whiteAlpha.900")(props),
        bg: vueThemeTools.mode("white", "gray.800")(props),
        transition: "background-color 0.2s",
        lineHeight: "base"
      },
      "*::placeholder": {
        color: vueThemeTools.mode("gray.400", "whiteAlpha.400")(props)
      },
      "*, *::before, &::after": {
        borderColor: vueThemeTools.mode("gray.200", "whiteAlpha.300")(props),
        wordWrap: "break-word"
      }
    };
  }
