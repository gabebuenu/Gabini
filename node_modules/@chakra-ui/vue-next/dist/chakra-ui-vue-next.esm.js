...
export { chakra } from '@chakra-ui/vue-system';
import { EmotionThemeContextSymbol, EmotionCacheInjectionSymbol } from '@chakra-ui/vue-styled';
import createCache from '@emotion/cache';
import { mergeWith, isFunction, get, runIfFn } from '@chakra-ui/utils';
...
function injectThemeGlobalStyles(theme, _cache, colorMode) {
  ...
  var globalStyles = computed(function () {
    return runIfFn(styleObjectOrFn, {
      theme: theme,
  ...
  var _globalStyles = computed(function () {
    return css(globalStyles.value)(theme);
  });

  var serializedStyles = computed(function () {
    return serializeStyles([_globalStyles.value], cache.registered, theme);
  });
  var sheetRef = ref();
  watch(function () {
    return cache;
...
var ChakraUIVuePlugin = {
  install: function install(app, options) {
    ...
    var theme = options.extendTheme || defaultTheme;
    ...
    var colorModeRef = ref(colorMode);
...
export { ChakraUIVuePlugin as default, extendChakra, extendTheme };
