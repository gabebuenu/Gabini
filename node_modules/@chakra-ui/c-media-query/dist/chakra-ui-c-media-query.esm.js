...
var CVisibility = defineComponent({
  props: {
    breakpoint: {
      type: String,
      required: true
  ...
  setup: function setup(props, _ref) {
    ...
    var show = useMediaQuery(props.breakpoint);
...
var CShow = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      return createVNode(CVisibility, {
...
export { CHide, CShow, CVisibility, useQuery };
