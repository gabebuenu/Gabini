 ...
 */
export declare const useId: (id?: string | undefined, prefix?: string | undefined) => import("vue").ComputedRef<string>;
/**
 ...
 */
export declare function useIds(id?: string, ...prefixes: string[]): import("vue").ComputedRef<string>[];
