/*!
  ...
  * @license MIT
  */
import { set, del, unref, ref, computed, watch, nextTick, reactive, isRef } from 'vue-demi';
import { useMediaQuery, isObject, unrefElement, useEventListener, useIntersectionObserver, noop, isNumber } from '@vueuse/core';
...
function useMotionTransitions() {
    ...
    const push = (key, value, target, transition = {}, onComplete) => {
        ...
        if (reducedMotion.value || (transition && transition.immediate)) {
    ...
    install(app, options) {
        ...
        if (options && options.directives) {
            ...
            for (const key in options.directives) {
                ...
                if (!variants.initial && (process.env.NODE_ENV !== 'production')) {
