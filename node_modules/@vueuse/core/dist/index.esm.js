import { isRef, ref, watchEffect, computed, customRef, unref, createApp, reactive, watch, getCurrentInstance, onMounted, onUpdated, toRefs as toRefs$1, shallowRef, markRaw, isVue2 } from 'vue-demi';
import { isClient, isString, noop, tryOnUnmounted, promiseTimeout, increaseWithUnit, useTimeoutFn, watchWithFilter, tryOnMounted, createFilterWrapper, bypassFilter, createSingletonPromise, containsProp, throttleFilter, timestamp, isFunction, isObject, ignorableWatch, isNumber, useIntervalFn, pausableFilter, clamp, pausableWatch } from '@vueuse/shared';
...
function useAsyncState(promise, initialState, options = {}) {
    const { immediate = true, delay = 0, onError = noop, } = options;
...
function useMediaControls(target, options = {}) {
    ...
    watchEffect(() => {
        ...
        el.playsInline = unref(options.playsinline);
        el.poster = unref(options.poster) || '';
    });
    /**
